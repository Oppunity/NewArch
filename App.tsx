...
import Settings from './src/screens/SettingPage';
import OrganizationSettingsPage from './src/screens/OrganizationSettingsPage';
import UserSettingPage from './src/screens/UserSettingPage';
...
screen: OrganizationSettingsPage,
navigationOptions: ({navigation}) => {  //destructure the navigation property here 
    return {
        headerShown: true,
